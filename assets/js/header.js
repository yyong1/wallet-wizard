  ...
  if (isUserLoggedIn()) {
    navbar = `
      <ul class="primary-menu">
          <li><a id="expenses-header"  href="#expenses" onclick="expenses.getexpenses()"    class="">Expenses</a></li>
          <li><a id="income-header" href="#income" onclick="incomes.getincomes()" class="">Income</a></li>
